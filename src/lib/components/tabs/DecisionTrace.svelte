...
<section class="trace-tab">
	...
	<p class="subtitle">
		Tool call decision chain — what ran, in what order, and what triggered the next step
	</p>
					...
					{#if selectedStep}
						...
						>
							<header class="card-head">
								...
								<span class="latency">{formatLatency(selectedStep.latencyMs)}</span>
							</header>

							<p class="meta-line">
								<time datetime={new Date(selectedStep.timestampMs).toISOString()}>

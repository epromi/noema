...
try {
  ...
  for (let i=1;i<lines.length;i++) {
    ...
    const cronDetail = {
      ...
      'Noema Refresh (2h)': {sched:'every 2h', desc:'🔄 Dashboard HTML regeneration from live data'},
      'Noema Product Research': {sched:'01:00 daily', desc:'🛠️ Dashboard analysis + web research + auto-fix (Flash, off-peak)'},
      'Noema Nightly QA': {sched:'03:00 daily', desc:'🧪 Nightly dashboard QA audit (03:00)'},
